    ...
    <title>
      ...
      <body className="flex bg flex-col min-h-screen w-full items-center justify-center">
        <div className="flex items-center justify-center">
          <div className="border-x bg-background border-neutral-600 max-w-[2000px] w-full z-50  dark:border-white/50 rounded-sm sm:mx-10 sm:my-10 border-y">
            <OverHeader />
            <Header />
                    ...
                    <div className="flex flex-col md:flex-row items-end container mx-auto px-4 sm:px-6 lg:px-8 justify-center gap-14 md:gap-24">
                      ...
                      <div className="flex flex-col md:w-1/3 justify-center space-y-4">
                        <div className="w-auto flex flex-col gap-4">
                          <p className="lg:text-2xl md:text-xl sm:text-md text-start ">
                        ...
                        <div className="flex flex-row gap-4">
                          <Button className="font-semibold" size="lg">Get Textuality free</Button>
                          <Button className="font-semibold" size="lg" variant="secondary">Learn more</Button>
                        </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="flex flex-row items-center gap-8">
                          ...
                          <div className="flex flex-row mt-10">
                            {/* Feature 1 */}
                            <div className="flex flex-col border p-3 shadow-sm hover:shadow-accent-foreground hover:shadow-md hover:border-accent-foreground transition-all items-start gap-4 w-1/3">
                              <EditIcon size={50} />
