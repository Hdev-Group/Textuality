...
import { Wrench, FolderPen, Image as ImageIcon, Component, Settings, Search, ArrowUp } from "lucide-react"
...
const navItems = [
  { icon: Wrench, label: "Model Creator", route: "/model-creator", activesection: "model-creator" },
...
export default function AppHeader({activesection}: any) {
  export default function HomeHeader({activesection}: any) {
    ...
    // check if dark mode is enabled via local storage
      const darkMode = document.documentElement.classList.contains('dark')
      const image = darkMode ? "/IMG_6128.png" : "/IMG_6129.png"
        ...
        <div className="px-10 mx-auto">
          <div className="flex w-full justify-between items-center py-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button id="themesetter" size="icon" variant="ghost" aria-label="Settings">
